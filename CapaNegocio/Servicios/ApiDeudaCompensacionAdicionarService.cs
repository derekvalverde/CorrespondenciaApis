...
{
    public class ApiDeudaCompensacionAdicionarService: IApiDeudaCompensacionAdicionarService
    {
        private readonly AppSettings _appSettings;
        private readonly ApplicationDbContext _context;
        public ApiDeudaCompensacionAdicionarService(IOptions<AppSettings> appSettings, ApplicationDbContext context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public clsDeudaCompensacionAdicionarResponse registrarDeudaCompensacion(clsDeudaCompensacionAdicionarCabeceraRequest deuda)
        {
            //
            ...
            cmd1.CommandText = "Api_DeudaCompensacionAdicionar";
