...
{
    public class ApiMaterialVentaPromocionMesesService: IApiMaterialVentaPromocionMesesService
    {
        private readonly AppSettings _appSettings;
        private readonly ApplicationDbContext _context;
        public ApiMaterialVentaPromocionMesesService(IOptions<AppSettings> appSettings, ApplicationDbContext context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public List<clsMaterialVentaPromocionMesesAgenciaResponse> obtenerVentaPromocionGrupoMeses(string matCodigo)
        {
            ...
            cmd.CommandText = "Api_MaterialVentaPromocionMeses";
