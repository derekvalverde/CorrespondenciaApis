...
{
    public class ApiDeudaCompensacionAdicionarClienteService:IApiDeudaCompensacionAdicionarClienteService
    {
        private readonly AppSettings _appSettings;
        private readonly ApplicationDbContext _context;
        public ApiDeudaCompensacionAdicionarClienteService(IOptions<AppSettings> appSettings, ApplicationDbContext context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public clsDeudaCompensacionAdicionarClienteResponse registrarDeudaCompensacionCliente(clsDeudaCompensacionAdicionarClienteCabeceraRequest deuda)
        {
            //
            ...
            cmd1.CommandText = "Api_DeudaCompensacionAdicionarCliente";
            ...
            if (decId > 0)
            {
                ...
                foreach (clsDeudaCompensacionDetalleAdicionarClienteRequest deudaDetalle in deuda.detalleDeudaCompensacionCliente)
                {
                    SqlCommand cmd4 = conn.CreateCommand();
                    cmd4.CommandType = System.Data.CommandType.StoredProcedure;

                    cmd4.CommandText = "Api_DeudaCompensacionDetalleAdicionarCliente";


                    cmd4.Parameters.Add("@decId", System.Data.SqlDbType.Int).Value = decId;
                    cmd4.Parameters.Add("@recId", System.Data.SqlDbType.Int).Value = recId;
            ...
            conn.Close();
            clsDeudaCompensacionAdicionarClienteResponse respuesta = new clsDeudaCompensacionAdicionarClienteResponse();
