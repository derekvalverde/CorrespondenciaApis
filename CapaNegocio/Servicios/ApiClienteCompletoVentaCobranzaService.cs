...
{
    public class ApiClienteCompletoVentaCobranzaService: IApiClienteCompletoVentaCobranzaService
    {
        private readonly AppSettings _appSettings;
        private readonly ApplicationDbContext _context;
        public ApiClienteCompletoVentaCobranzaService(IOptions<AppSettings> appSettings, ApplicationDbContext context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public List<clsClienteCompletoVentaCobranzaResponse> obtenerCompletoCobranza(int usuId)
        {
            ...
            cmd.CommandText = "Api_ClienteCompletoVentaCobranza";

            cmd.Parameters.Add("@usuId", System.Data.SqlDbType.Int).Value = usuId;


            var chequePendiente = new List<clsClienteCompletoVentaCobranzaResponse>();
        ...
        private clsClienteCompletoVentaCobranzaResponse MapToValue(SqlDataReader reader)
        {

            return new clsClienteCompletoVentaCobranzaResponse()
            {
