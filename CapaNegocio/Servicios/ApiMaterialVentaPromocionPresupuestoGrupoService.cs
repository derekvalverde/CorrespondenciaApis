...
{
    public class ApiMaterialVentaPromocionPresupuestoGrupoService: IApiMaterialVentaPromocionPresupuestoGrupoService
    {
        private readonly AppSettings _appSettings;
        private readonly ApplicationDbContext _context;
        public ApiMaterialVentaPromocionPresupuestoGrupoService(IOptions<AppSettings> appSettings, ApplicationDbContext context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public List<clsMaterialVentaPromocionPresupuestoGrupoAgenciaResponse> obtenerVentaPresupuesto(string matCodigo)
        {
            ...
            cmd.CommandText = "Api_MaterialVentaPromocionPresupuestoGrupo";
