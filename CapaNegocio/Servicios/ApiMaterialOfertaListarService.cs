...
{
    public class ApiMaterialOfertaListarService:IApiMaterialOfertaListarService
    {
        private readonly AppSettings _appSettings;
        private readonly ApplicationDbContext _context;
        public ApiMaterialOfertaListarService(IOptions<AppSettings> appSettings, ApplicationDbContext context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public List<clsMaterialVentaStockResponse> obtenerOfertas(string ageOficina, string cliCodigo )
        {
            //
            ...
            cmd.CommandText = "Api_MaterialOfertaListar";
            cmd.Parameters.Add("@ageOficina", System.Data.SqlDbType.Int).Value = ageOficina;
            var ofertas = new List<clsMaterialVentaStockResponse>();
            var reader = cmd.ExecuteReader();
            
            while (reader.Read())
            {               
               ofertas.Add(MapToValueOfertas(reader));
            }
            conn.Close();
